...
object RadioDbSchema {
    ...
    fun stagingStatements(prefix: String) = listOf(
        "CREATE TABLE ${prefix}stg_r_station (sta TEXT PRIMARY KEY, adm_id INTEGER)",
        "CREATE TABLE ${prefix}stg_r_support (sta TEXT, sup TEXT, lat_e6 INTEGER, lon_e6 INTEGER, " +
            "nat_id INTEGER, tpo_id INTEGER, height_dm INTEGER, code_insee TEXT, address TEXT, " +
            "PRIMARY KEY (sta, sup))",
        "CREATE TABLE ${prefix}stg_r_antenne (aer TEXT PRIMARY KEY, sta TEXT, sup TEXT, tae_id INTEGER, sample TEXT)",
        "CREATE TABLE ${prefix}stg_r_emetteur (emr TEXT, sta TEXT, aer TEXT, system TEXT)",
        "CREATE TABLE ${prefix}stg_r_bande (emr TEXT, f_deb TEXT, f_fin TEXT, unite TEXT)",
        "CREATE TABLE ${prefix}stg_r_single (sta TEXT PRIMARY KEY, sup TEXT)",
        "CREATE TABLE ${prefix}stg_r_sel (emr TEXT PRIMARY KEY, sta TEXT, sup TEXT)",
    )
