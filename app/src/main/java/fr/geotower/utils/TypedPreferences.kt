...
object MapDisplayPrefs {
    ...
    val mapRotationEnabled = BooleanPreference(AppConfig.PREF_MAP_ROTATION_ENABLED, AppConfig.DEFAULT_MAP_ROTATION_ENABLED)
    val mapFollowOrientation = BooleanPreference(AppConfig.PREF_MAP_FOLLOW_ORIENTATION, AppConfig.DEFAULT_MAP_FOLLOW_ORIENTATION)
