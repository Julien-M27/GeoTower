...
object MapFilterDefaults {
    ...
    private val booleanFilters: List<BooleanFilter> = listOf(
        ...
        BooleanFilter(AppConfig.PREF_SHOW_PROJECT_SITES, AppConfig.showProjectSites, factory = true),
    ...
    fun reference(prefs: SharedPreferences): Reference {
        ...
        return Reference(
            ...
            showProjectSites = ref(AppConfig.PREF_SHOW_PROJECT_SITES),
