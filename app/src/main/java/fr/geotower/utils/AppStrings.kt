...
object AppStrings {
    ...
    val devCredit @Composable get() = get("Développé par Julien et Gemini 😉", "Developed by Julien and Gemini 😉", "Desenvolvido por Julien e Gemini 😉")
    val srcAntennas @Composable get() = get("Données Antennes", "Antenna Data", "Dados de Antenas")
    val srcAntennasDesc @Composable get() = get("Agence Nationale des Fréquences (ANFR). Données issues de Cartoradio (Open Data).", "National Frequency Agency (ANFR). Data from Cartoradio (Open Data).", "Agência Nacional de Frequências (ANFR). Dados do Cartoradio (Open Data).")
    ...
    val srcInspoDesc @Composable get() = get("• © CellularFR développé par Luis Baker avec ❤️\n• © Signal Quest développé par Alexandre Germain avec ❤️\n• © RNC Mobile développé par Cédric avec ❤️\n• © eNB-Analytics développé par Tristan com ❤️\n• © GeoRadio - L'icône alternative provient de l'application GéoRadio sur iOS développée avec ❤️ par Hugo Martin.\n• Concept original basé sur l'application GéoRadio\n• Icône fun dessinée par Johan", "• © CellularFR developed by Luis Baker with ❤️\n• © Signal Quest developed by Alexandre Germain with ❤️\n• © RNC Mobile developed by Cédric with ❤️\n• © eNB-Analytics developed by Tristan with ❤️\n• © GeoRadio - The alternative icon comes from the GéoRadio iOS app developed with ❤️ by Hugo Martin.\n• Original concept based on the GéoRadio app\n• Fun icon designed by Johan", "• © CellularFR desenvolvido por Luis Baker com ❤️\n• © Signal Quest desenvolvido por Alexandre Germain com ❤️\n• © RNC Mobile desenvolvido por Cédric com ❤️\n• © eNB-Analytics desenvolvido por Tristan com ❤️\n• © GeoRadio - O ícone alternativo vem da aplicação GéoRadio para iOS desenvolvida com ❤️ por Hugo Martin.\n• Conceito original baseado na aplicação GéoRadio\n• Ícone divertido desenhado por Johan")
