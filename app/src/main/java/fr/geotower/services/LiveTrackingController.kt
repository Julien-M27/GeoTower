...
object LiveTrackingController {
    ...
    // L'exemption des optimisations d'énergie (REQUEST_IGNORE_BATTERY_OPTIMIZATIONS) a été retirée
    // avec la carte de réglage qui l'exposait : Google Play exige une fonction coeur qui la
    // justifie, et une permission déclarée sans appelant est un motif de rejet gratuit.
